    ...
    render() {
        return (
            ...
            <div style={{ height: "670px" }}>
                ...
                <br />  <br />  <br />
                <h3 style={{ textAlign:"left", padding:30}}>Contact Us</h3>
                <br />
                <div style={{ borderStyle: "inset", width: "80%", backgroundColor: "LightGray", marginLeft: "30px", padding: "40px" }}>
                <form name="form" id="form" ref={form => this.form = form} enctype="text/plain" target="hidden_iframe" onSubmit={this.onSubmit}>
                        <div class="row">
                            <div class="column">
                                Name: <input type="text" id="entry.1238625935" name="name" size="25" /><br /><br />
                        Email: <input type="text" id="entry.941955885" name="email" size="25" /><br /><br />
                        Message:<textarea id="entry.1797898034" name="message"rows="4" cols="28" /><br /><br /><br /><br /><br /><br />
                            </div>
                            <br/>
                            <br/>
