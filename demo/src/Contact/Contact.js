            ...
            <div style={{ height: "670px" }}>
                ...
                <form name="form" id="form" ref={form => this.form = form} enctype="text/plain" target="hidden_iframe" onSubmit={this.onSubmit}>
                        ...
                        Message<br /><br /><br /><br /><br /><br />
                            ...
                            <div class="column">
                                <input type="text" id="entry.1238625935" name="name" size="25" /><br /><br />
                                <input type="text" id="entry.941955885" name="email" size="25" /><br /><br />
                                <textarea id="entry.1797898034" name="message"rows="4" cols="28" />
