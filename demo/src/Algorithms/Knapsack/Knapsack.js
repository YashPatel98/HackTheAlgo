    ...
    return (
      ...
      <div>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <p style={{ fontSize: "20px" }}> <b>The Knapsack Problem is a Dynamic Programming Problem that falls in the optimization category. Given a set of items with specific weights and assigned values, the goal is to maximize the value in a knapsack while remaining within the weight constraint. Each item can only be selected once, as we don’t have multiple quantities of any item.</b> </p>

        Knapsack Capacity<input type="text" ref={node => { n = node; }} /> &nbsp;
        Weight<input type="text" ref={node => { edges = node; }} /> &nbsp;
        Value<input type="text" ref={node => { edges1 = node; }} /> &nbsp;
          ...
          <h3 style={{ marginLeft: "950px" }}>HELP</h3>
